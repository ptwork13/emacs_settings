...
(setq YaTeX-dvi2-command-ext-alist
      '(("TeXworks\\|texworks\\|texstudio\\|mupdf\\|SumatraPDF\\|Preview\\|Skim\\|TeXShop\\|evince\\|okular\\|zathura\\|qpdfvihew\\|Firefox\\|firefox\\|chrome\\|chromium\\|Adobe\\|Acrobat\\|AcroRd32\\|acroread\\|pdfopen\\|xdg-open\\|open\\|start" . ".pdf")))
...
;;PHPの環境設定
(add-to-load-path "elpa/php-mode")
(require 'php-mode)
...
(custom-set-variables
 ...
 '(initial-frame-alist (quote ((top . 35))))
 '(package-archives
   (quote
